...
class Class {
    constructor(course, teacher, students) {
        ...
        for (let i = 0; i < students.length; i++) {
            this.studentProgress[students[i].id] = new StudentProgress(this)
        }
    }

    addStudent(student) {
        this.studentProgress[student.id] = new StudentProgress(this)
    }
}
...
app.post('/', function(req, res) {
    res.send("Here is the text you should print!")
});
